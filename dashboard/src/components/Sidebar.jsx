...
export default function Sidebar({ collapsed, onToggle }) {
  ...
  return (
    <aside className={`k-sidebar ${collapsed ? 'k-sidebar--collapsed' : ''}`}>
      <Link to="/clinico" className="k-sidebar-logo" title="Ir para a Página Inicial">
      ...
      <button className="k-sidebar-toggle" onClick={onToggle} title={collapsed ? "Expandir menu" : "Recolher menu"}>
